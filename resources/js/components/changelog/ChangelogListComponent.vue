  ...
  <span>
    <v-toolbar color="primary">
      ...
      <v-btn flat class="white--text" @click="realTime=!realTime">
        <span class="mr-1">Temps real</span>
        <v-icon v-if="realTime">check_box</v-icon>
              ...
              <v-layout justify-space-between>
                <v-flex xs2 text-xs-left align-self-center>
                  <template v-if="log.user_name">
                    <user-avatar class="mr-2" :email="log.user_gravatar" :alt="log.user_name"></user-avatar>
                ...
                <v-flex xs1 text-xs-left align-self-center>
                  <timeago
                    v-if="realTime"
                    :title="log.formatted_time"
                    :datetime="typeof log.time === 'object' ? log.time.date : log.time"
                    :auto-update="1"
                ...
                <v-flex xs1 text-xs-left align-self-center>
                  <json-dialog-component
                    name="Àntic"
                    title="Objecte en el moment de la modificació"
      ...
      window.axios
        ...
        .then(response => {
          this.$snackbar.showMessage(
            "Registre de canvis actualitzat correctament"
          );
